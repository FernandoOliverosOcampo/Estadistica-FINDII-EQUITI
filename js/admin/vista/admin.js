        ...
        <div class="informacion-editar">
            ...
            <div class="contenido-venta">
                ...
                <div class="campo compania">
                    ...
                    <div class="entrada">
                        <input type="text" id="campoCompañiaEditar" value = "${dato['compania']}">
                    </div>
                </div>
            ...
            <div class="campo dni">
                ...
                <div class="entrada">
                    <input type="text" id="campoDniEditar" value = "${dato['dni']}">
                </div>
            </div>
                ...
                <div class="entrada">
                    <input type="text" id="campoNombreEditar" value = "${dato['nombre']}">
                </div>
                </div>
                ...
                <div class="campo telefono">
                    ...
                    <div class="entrada">
                        <input type="text" id="campoTelefonoEditar" value = "${dato['telefono']}">
                    </div>
                </div>
                ...
                <div class="entrada">
                    <input type="text" id="campoCorreoEditar" value = "${dato['correo']}">
                </div>
                </div>
                ...
                <div class="entrada">
                    <input type="text" id="campoDireccionEditar" value = "${dato['direccion']}">
                </div>
                </div>
                ...
                <div class="campo fecha-nacimiento">
                    ...
                    <div class="entrada">
                        <input type="text" id="campoFechaNacimientoEditar" value = "${dato['fecha_nacimiento']}">
                    </div>
                </div>
                ...
                <div class="campo cups-luz">
                    ...
                    <div class="entrada">
                        <input type="text" id="campoCupsLuzEditar" value = "${dato['cups_luz']}">
                    </div>
                </div>
                ...
                <div class="campo cups-gas">
                    ...
                    <div class="entrada">
                        <input type="text" id="campoCupsGasEditar" value = "${dato['cups_gas']}">
                    </div>
                </div>
                ...
                <div class="campo iban">
                    ...
                    <div class="entrada">
                        <input type="text" id="campoIbanEditar" value = "${dato['iban']}">
                    </div>
                </div>
                ...
                <div class="campo numero-contrato">
                    ...
                    <div class="entrada">
                        <input type="text" id="campoNumeroContratoEditar" value = "${dato['numero_contrato']}">
                    </div>
                </div>
                ...
                <div class="campo potencia">
                    ...
                    <div class="entrada">
                        <input type="text" id="campoPotenciaEditar" value = "${dato['potencia']}">
                    </div>
                </div>
                ...
                <div class="campo peajeGas">
                    ...
                    <div class="entrada">
                        <input type="text" id="campoPeajeGasEditar" value = "${dato['peaje_gas']}">
                    </div>
                </div>
                ...
                <div class="campo descripcion-venta">
                    ...
                    <div class="entrada">
                        <textarea id="observacionesVenta">${dato['observaciones_venta']}</textarea>
                    </div>
                </div>
