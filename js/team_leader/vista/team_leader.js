...
const Vista = {
    ...
    datosEstadisticos(res) {
        ...
        this.llenarCuadroVentasTotales(prom_venta_semana_actual, "Promedio semana actual")
    ...
    llenarEstadisticasAgente(res) {
        ...
        const contenedorEstadoVentasAgente = document.getElementById('contenedorEstadoVentasAgente');
